...
> Last verified against repo state: 2026-05-24 13:10 UTC
>
...
| P1-4         | P1  | pending  | -     | -        | -           | -                | UI Design Spec §3            | Image preview expansion: EXIF metadata display, gallery/lightbox mode for browsing images in directory                                                                                                    | None     | 2026-05-24    |
| P2-12        | P2  | pending  | -     | -        | -           | -                | UI Design Spec §4            | Symlink policy: show symlink indicator in file list, warn on symlink operations, handle symlink targets in copy/move                                                                                      | None     | 2026-05-24    |
| P2-13        | P2  | pending  | -     | -        | -           | -                | UI Design Spec §3            | PDF/media/EXIF preview: in-app PDF viewer, audio/video preview with playback controls, EXIF metadata panel in Properties                                                                                  | None     | 2026-05-24    |
| P2-14        | P2  | pending  | -     | -        | -           | -                | UI Design Spec §3            | Saved searches / smart folders: persistent virtual views with live-updating results                                                                                                                       | None     | 2026-05-24    |
| P2-16        | P2  | pending  | -     | -        | -           | -                | UI Design Spec §3            | Archive browsing: browse archive contents (.zip/.tar/.tar.gz) without extraction                                                                                                                          | None     | 2026-05-24    |
| P3-2         | P3  | pending  | -     | -        | -           | -                | UI Design Spec §6            | Eject/unmount: safely eject removable volumes from sidebar or context menu                                                                                                                                | None     | 2026-05-24    |
| P3-3         | P3  | pending  | -     | -        | -           | -                | UI Design Spec §6            | Job pause/resume: pause and resume long-running file operations without cancel                                                                                                                            | None     | 2026-05-24    |
| RC-PAUSE     | P2  | pending  | -     | -        | -           | -                | UI §6; RC spec §3.2          | Pause on jobs: backend job.pause IPC + UI pause/resume button in activity panel                                                                                                                           | None     | 2026-05-24    |
| TAG-1        | P2  | pending  | -     | -        | -           | -                | UI Design Spec §3            | Tag/label system: assign color tags to files/folders, filter by tag, persisted tag store                                                                                                                  | None     | 2026-05-24    |
| RMT-1        | P2  | pending  | -     | -        | -           | -                | UI Design Spec §2            | Remote providers expansion: SMB and S3 protocol support beyond current SFTP                                                                                                                               | None     | 2026-05-24    |
