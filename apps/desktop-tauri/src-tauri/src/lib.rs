...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::network::network_providers_list,
            ...
            commands::terminal::terminal_capabilities,
            commands::terminal::terminal_profiles_list,
            commands::terminal::terminal_profile_add,
            commands::terminal::terminal_profile_update,
            commands::terminal::terminal_profile_delete,
            commands::terminal::terminal_profile_set_default,
            commands::terminal::terminal_sessions_list,
            commands::terminal::terminal_send_text,
            commands::terminal::terminal_run_command,
            commands::terminal::terminal_spawn_and_run,
